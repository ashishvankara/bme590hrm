...
def readCsv(name):
    ...
    This function extracts ECG data from a csv and stores it in the appropriate lists.
    ...
    if len(t) != len(v):
        logging.error("Length of time column is unequal to the length of the voltage column")
        raise TypeError("Length of time column is unequal to the length of the voltage column")
    print(t)
    print(v)
    return [t, v]
